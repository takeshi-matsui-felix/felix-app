...
st.set_page_config(page_title="スマホ内・瞬間圧縮テスト V5", layout="centered")
...
# 🛠️ 【修正箇所】「絶対パス」を使って、Streamlitに確実にフォルダを認識させる
current_dir = os.path.dirname(os.path.abspath(__file__))
COMPONENT_DIR = os.path.join(current_dir, "fast_camera_comp_v5")
...
def client_compress_component():
    component_func = components.declare_component("fast_camera_v5", path=COMPONENT_DIR)
    return component_func(key="fast_camera_test_v5")

# ==========================================
# 画面表示
# ==========================================
st.title("⚡ スマホ内・瞬間圧縮テスト V5")
