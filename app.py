...
ISSUE_TEMPLATES = {
    ...
    "躯体検査": {
        ...
        "外部金物": ["外部　帯金物S-45が無い", "外部　帯金物S-45×2が無い", "VPの固定不良", "S-65の固定不良", "TS金物の固定不良", "コーナー金物の固定不良"],
        "釘打ち関連": ["大引きの釘打ち不良", "根太の釘打ち不良", "合板の釘打ち不良。＠150", "合板の釘めり込み", "合板が柱・スタッドに掛かっていない", "合板目地が空いていない", "壁合板の釘打ち不良。＠100", "壁合板の釘打ち不良。＠150", "合板がスタッドに掛かっていない", "合板の目地が空いていない", "開口補強の釘打ち不良", "屋根合板の釘打ち不良。＠150", "合板がたる木に掛かっていない"],
        "防腐・防蟻処理": ["防腐防蟻処理の塗布忘れ、もしくは処理不足", "防腐防蟻処理の塗布忘れ、もしくは処理不足（玄関）", "防腐防蟻処理の塗布忘れ、もしくは処理不足（ＵＢ）"],
        "継手・欠き込み関連": ["頭つなぎの継手位置不良。スタッド上で継ぐ", "上枠の継手位置不良。スタッド上で継ぐ", "204の欠き込みが大きすぎるため補強が必要", "スタッドの切り詰めが不適（スタッドの補強が必要）", "マグサの施工不良"],
        "屋根関連": ["ころび止め未施工", "あおり止め金物未施工", "あおり止め金物釘打ち不良", "たる木ひねり金物（TS）の施工忘れ、もしくは施工不良"],
        "その他金物": ["各種金物の施工忘れ、もしくは施工不良", "各種金物の釘打ち不良"]
    },
    "中間検査": {
        "PB関連": ["PB張り不足", "PB張り上げ不足。母屋たる木まで張り上げ。", "PBボード開口が大き過ぎる。石膏ボード張り増しすること", "ＰＢ留め付け不良※全室、全箇所確認のこと", "開口部周りＰＢ留め付け不良※全室、全箇所確認のこと", "竪穴区画範囲の壁PBは合板下端まで張り上げること　施工マニュアル（ＳＴ－０２－０１）確認のこと", "竪穴区画範囲の壁PBは隙間なく張り付けること", "壁PB施工がされていない（矩計図参照）", "外壁壁はPBをモヤ下まで張りあげる", "PS内の床に石膏ボード12.5張りがされていない", "界壁ＰＢの床根太、床合板取合い耐火材（スキマナイト等）未処理　※全室、全箇所確認のこと", "壁PBジョイントあて木なし（留め付けなし）"],
        "ビス・ビスピッチ": ["ビスピッチ不良　壁：外周部＠100中間部＠200になっていない＊全住戸確認すること", "150φダクト貫通部の開口補強下地に全周ビス固定＠100がされていない　※全室、全箇所確認のこと　", "ボードビスなし　※全室、全箇所確認のこと"],
        "界壁関連": ["界壁の遮音シートは、野地合板まで施工すること", "界壁は野地合板まで施工"],
        "貫通部・隙間処理": ["縦管の音ナイン等に隙間処置をすること", "施工範囲内に音ナイン等が施工されていない", "電気配線界壁貫通", "竪穴区画内　日東化成株式会社（プラシール　NF-12HM）未済", "電気配線等の貫通部隙間の不燃材埋め（注意喚起）", "各種配管等の貫通部隙間の不燃材埋め", "150Φダクトの貫通部隙間不燃材（ロックウール等）埋め", "基礎と土台の隙間処理（現場発泡ウレタン）が施工されていない　※外周部と玄関土間周り"],
        "ダクト・配線関連": ["壁内のダクト被覆が無い", "電気配線の縦貫通が1/2を超えている。PGで補強", "150Φダクト壁貫通位置不良。開口補強追加施工、もしくは開口補強位置是正", "鋼製ダクト（スパイラル管）未施工"],
        "防振関連": ["防振根太に固定金物を使用している。防振根太から根太に固定金物位置を移動する", "防振根太に固定金物使用。防振根太から根太に固定金物位置を移動", "防振吊り木受け材の床根太とのクリアーなし", "防振吊り木受け材のころびとのクリアーなし"],
        "水道関連": ["基礎　立上り断熱材　隙間の処理が現場発泡ウレタンで塞いでいない"],
        "その他": ["ニッチのサイズ不良", "ニッチの設置高さ不良", "壁の断熱材が隙間なく充填されていない", "壁の断熱材が防湿フィルムで覆われていない（耳を柱に見付けタッカー留め）", "コンセントボックス、スイッチボックス周りの防湿処理が不十分", "床の断熱材が隙間なく充填されていない（大引きとの取合い・配管周り等の隙間など）", "床の断熱材が専用ピンで大引き等に密着するよう留め付けられていない", "天井の断熱材が隙間なく充填されていない（各種配線、配管等の貫通部の隙間など）", "天井の断熱材が防湿フィルムで覆われていない（耳を野縁に見付けタッカー留め）", "ダウンライト等の天井開口部周りの断熱処理不十分", "点検口等の開口部周りの断熱処理不十分", "バルコニー等の直下部における天井断熱材が隙間なく充填されていない", "外断熱材のジョイント部における気密テープ処理不十分", "外断熱材の開口部周りにおける気密テープ処理不十分", "サッシ周りの断熱処理不十分（現場発泡ウレタン等）", "玄関ドア周りの断熱処理不十分（現場発泡ウレタン等）", "浴室周りの断熱処理（基礎断熱、壁断熱、天井断熱）が不十分", "ユニットバス下部の基礎断熱処理不十分", "通気層が確保されていない（外壁、屋根など）", "通気層の入り口（土台水切り部など）が塞がれている", "通気層の出口（軒天、棟部など）が塞がれている", "防湿フィルムの破れ、剥がれがある場合は補修テープで処理すること", "防湿フィルムのジョイント部における重なり幅が不足している", "防湿フィルムのジョイント部におけるテープ処理不十分", "外壁透湿防水シートの破れ、剥がれがある場合は補修テープで処理すること", "外壁透湿防水シートのジョイント部における重なり幅が不足している", "外壁透湿防水シートのジョイント部におけるテープ処理不十分", "サッシ周りの防水テープ処理不十分", "配管等の貫通部周りの防水テープ処理不十分", "バルコニー防水層（FRP等）の施工不良（ひび割れ、浮き、ピンホールなど）", "バルコニー防水層の立ち上がり高さ不足", "バルコニー防水層とサッシ等の取合い部における防水処理不十分", "屋根葺き材の施工不良（割れ、浮き、ズレなど）", "屋根ルーフィングの破れ、剥がれがある場合は補修テープで処理すること", "屋根ルーフィングのジョイント部における重なり幅が不足している", "屋根ルーフィングの谷部、ケラバ部等における増張り処理不十分"]
    },
    "社内検査(設計)": {
        "玄関": {
            ...
            "玄関ドア外": ["玄関戸の戸当たりなし", "英文字の位置を玄関戸ライン側に是正", "玄関戸固定ビスとコーキング未施工", "玄関戸固定ビス頭コーキング未施工", "玄関戸下のはみだし材除去", "玄関戸固定シールはみ出し。サッシ固定ビスなし。", "玄関戸アングルピース下隙間及び横隙間のシーリング、及び固定ビス頭コーキング未施工", "玄関戸下のはみ出しシール材カット"],
            "玄関ドア扉": ["玄関戸キズあり。リペア", "玄関戸丁番のビスキャップが無い", "玄関戸の開閉かたい", "玄関戸凹み", "玄関戸へこみキズあり"],
            "土間・タイル": ["玄関戸外の土間のモルタル仕上り不良", "玄関戸内の土間のモルタル仕上り不良", "玄関戸外の土間のモルタル汚れ、白華", "玄関戸内の土間のモルタル汚れ、白華", "玄関タイルの目地不良", "玄関タイルの割れ、欠け", "玄関タイルの浮き"],
            "ポーチ・階段": ["玄関ポーチの階段蹴上げ高さ不均一", "玄関ポーチの階段踏面勾配不良（水たまり）"],
            "手摺": ["玄関手摺の固定不良（がたつき）", "玄関手摺の高さ、位置不良"],
            "電気設備": ["照明器具の点灯不良", "スイッチ、コンセントのプレート曲がり、隙間", "分電盤のカバー取付不良", "分電盤内の結線不良、表示間違い", "火災報知器の設置位置不良", "インターホンの作動不良"],
            "外部設備": ["ポストの取付不良、傾き", "表札の取付不良、傾き", "宅配ボックスの作動不良", "外水栓の漏水、固定不良", "雨水桝の高さ不良（土間とフラットでない）", "汚水桝の高さ不良（土間とフラットでない）"],
            "基礎まわり": ["基礎巾木のモルタル仕上り不良", "基礎巾木のモルタル汚れ、白華"],
            "外壁・軒天": ["外壁サイディングの汚れ、キズ", "外壁サイディングのシーリング不良", "軒天の汚れ、キズ", "軒天の塗装不良"]
        },
        "トイレ": {
            ...
            "巾木関係": ["巾木浮き、歪み是正", "巾木小口処理", "巾木下の隙間をコーキング処理（コーキング　白）", "巾木下の隙間をコーキング処理（ボンドコーク　白）", "巾木反り", "巾木留め付けビス頭処理（同色ボンドコーク）"],
            "便器関係": ["便器の固定不良（がたつき）", "便器からの漏水", "ウォシュレットの作動不良"],
            "手洗い器": ["手洗い器の固定不良（がたつき）", "手洗い器からの漏水"],
            "換気・電気設備": ["換気扇の作動不良、異音", "照明器具の点灯不良", "スイッチ、コンセントのプレート曲がり、隙間"],
            "サッシ・窓枠": ["窓サッシの開閉不良", "窓サッシの鍵（クレセント）作動不良", "窓枠のキズ、汚れ"],
            "クロス": ["壁クロスの剥がれ、浮き、汚れ"]
        },
        "キッチン": {
            ...
            "ＰＢ関係": ["壁PB留め付けピッチ不良", "天井PB貼り不足", "PB貼り不足"],
            "キッチンパネル関係": ["キッチンパネルのキズ、汚れ", "キッチンパネルのジョイント部処理不良"],
            "各種設備関係": ["システムキッチンの扉調整（傾き、段差）", "システムキッチンの引き出し調整（がたつき、干渉）", "システムキッチンの取手固定不良", "シンクのキズ、汚れ", "水栓金具の固定不良（がたつき）", "水栓金具からの漏水", "浄水器の作動不良", "食洗機の作動不良、水漏れ", "IHクッキングヒーター／ガスコンロの作動不良", "レンジフードの作動不良、異音", "吊戸棚の固定不良", "床下収納庫の枠のがたつき、段差", "床下収納庫の蓋の開閉不良", "照明器具の点灯不良", "スイッチ、コンセントのプレート曲がり、隙間", "給気口の作動不良"],
            "床フローリング": ["床フローリングのキズ、汚れ、床鳴り"]
        },
        "LDK": {
            ...
            "サッシ・サッシ周り関係": ["サッシ固定ビスコーキング処理なし", "サッシ固定ビスなし コーキング処理なし", "サッシ固定シールはみ出し", "サッシ固定シールはみ出し。サッシ固定ビスなし。", "サッシ固定ビス傾き。是正後、ビス頭コーキング処理。", "サッシレール歪みあり", "サッシの開閉が重い", "サッシの鍵（クレセント）がかかりにくい", "網戸の動きが悪い、外れやすい", "網戸の破れ、たるみ", "サッシ枠のキズ、へこみ", "窓枠（膳板）のキズ、汚れ"],
            "クロス関係": ["壁クロスの剥がれ、浮き、汚れ、隙間", "天井クロスの剥がれ、浮き、汚れ、隙間"],
            "床フローリング": ["床フローリングのキズ、へこみ、汚れ", "床鳴り（歩行時の異音）", "床の不陸（傾き、段差）"],
            "階段関連": ["階段の踏み鳴り、きしみ", "階段手摺の固定不良（がたつき）", "階段の蹴込み板、側板の隙間"],
            "電気設備関連": ["照明器具の点灯不良", "スイッチ、コンセントのプレート曲がり、隙間", "TV端子、LAN端子の導通不良", "エアコンスリーブのキャップ未設置", "24時間換気口の作動不良", "火災報知器の設置位置不良"]
        },
        "バルコニー": {
            ...
            "排水関係": ["排水溝仕上り不良", "排水目皿なし", "排水桝なし"],
            "その他": ["バルコニー手摺の固定不良（がたつき）", "バルコニー手摺のキズ、汚れ", "物干し金物の固定不良、高さ・位置不良", "FRP防水層のひび割れ、浮き", "FRP防水層のトップコート色ムラ、剥がれ", "バルコニーサッシ下端の防水処理不良", "バルコニーの勾配不良（水たまり）", "外壁サイディングのジョイント部シーリング不良", "笠木のジョイント部シーリング不良", "笠木の固定不良、キズ"]
        },
        "洋室": {
            "引き戸": ["引き戸建具調整", "左が奥に是正", "引き戸の建付け調整。閉めたときに隙間あり。", "引き戸建具開閉時に引っ掛かりあり", "引き戸建具枠小口処理", "引き戸 戸当たりクッションカット", "引き戸の引手浮き調整", "引き戸建具枠下とフローリングの隙間コーキング"],
            "クローゼット": ["CL建具調整（ストッパーに位置を5㎝に是正）", "CL建具開閉時に引っ掛かりあり", "CL建具枠上の隙間コーキング", "CL建具枠小口処理", "CL建具枠のビスキャップが無い", "扉と扉の接触", "CL建具枠下とフローリングの隙間コーキング"],
            "枕棚・ハンガーパイプ": ["枕棚のクロス取合い隙間", "枕棚の固定不十分", "枕棚の前框がたつき", "枕棚上の雑巾ずり浮き", "ハンガーパイプの固定不良（がたつき）", "ハンガーパイプのキズ"],
            "クロス関係": ["壁クロスの剥がれ、浮き、汚れ、隙間", "天井クロスの剥がれ、浮き、汚れ、隙間"],
            "床フローリング": ["床フローリングのキズ、へこみ、汚れ", "床鳴り（歩行時の異音）"],
            "巾木": ["巾木浮き、隙間", "巾木小口処理"],
            "サッシ関係": ["サッシの開閉が重い", "サッシの鍵（クレセント）がかかりにくい", "網戸の動きが悪い、外れやすい", "網戸の破れ、たるみ", "窓枠（膳板）のキズ、汚れ"],
            "電気設備関連": ["照明器具（シーリングローゼット）の取付不良", "スイッチ、コンセントのプレート曲がり、隙間", "TV端子、LAN端子の導通不良", "エアコンスリーブのキャップ未設置", "24時間換気口の作動不良", "火災報知器の設置位置不良"]
        },
        "洗面室": {
            ...
            "フロアタイル": ["フロアタイルと巾木との取合い隙間あり(フロアタイルカットし過ぎ)", "フロアタイルの浮き、剥がれ", "フロアタイルのキズ、汚れ"],
            "洗面化粧台": ["洗面化粧台の扉調整（傾き、段差）", "洗面化粧台の引き出し調整（がたつき）", "洗面ボウルのキズ、汚れ", "水栓金具からの漏水", "排水管からの漏水", "洗面化粧台と壁の隙間コーキング不良"],
            "洗濯機関係": ["洗濯機パンの固定不良", "洗濯機パンの排水トラップ未設置、緩み", "洗濯機用水栓の固定不良、漏水"],
            "クロス関係": ["壁クロスの剥がれ、浮き、汚れ", "天井クロスの剥がれ、浮き、汚れ"],
            "換気・電気設備": ["換気扇の作動不良、異音", "照明器具の点灯不良", "スイッチ、コンセントのプレート曲がり、隙間"],
            "床下点検口": ["床下点検口の枠のがたつき、段差"],
            "分電盤": ["分電盤のカバー取付不良"]
        },
        "UB": {
            ...
            "ダクト関連": ["ダクトジョイント処理不良", "ダクト支持固定不十分", "ダクト余長を減らす", "ダクト蛇行是正", "ダクト未施工"],
            "浴槽・洗い場関係": ["浴槽のキズ、汚れ", "洗い場床のキズ、汚れ、水はけ不良", "壁パネルのキズ、汚れ", "天井パネルのキズ、汚れ"],
            "水栓金具・シャワー関係": ["水栓金具の固定不良、漏水", "シャワーフックの固定不良"],
            "鏡・カウンター・棚関係": ["鏡のキズ、汚れ、固定不良", "カウンターの傾き、固定不良", "タオル掛け、収納棚の固定不良"],
            "電気設備関係": ["照明器具の点灯不良", "換気乾燥暖房機の作動不良、異音"],
            "その他": ["排水口の部品欠品、水はけ不良", "コーキングの打ち忘れ、仕上がり不良", "点検口の蓋のがたつき、閉まり不良", "給湯器リモコンの作動不良", "窓サッシの開閉不良、鍵作動不良", "ブラインドの作動不良", "浴槽エプロンのガタつき"]
        },
        "廊下・階段・ENT": {
            "排水カバー": ["排水カバーはタイルまで落とす", "排水カバーは土間まで落とす"],
            "土台水切り": ["土台水切り納まり不良", "土台水切り施工範囲不良", "土台水切りゆがみ", "土台水切りが寸足らず", "土台水切りエンドキャップ取付け", "土台水切りの矩が出ていない"],
            "サイディング": ["サイディング小口未処理", "サイディング小口未処理（１階廊下）", "サイディング小口未処理（２階廊下）", "サイディング小口未処理（３階廊下）", "サイディングシール押さえ不良", "サイディング納まり不良", "サイディングキズ", "エントランス戸上、サイディング隙間処理"],
            "共用部廊下": ["共用部廊下の長尺シート浮き、剥がれ", "共用部廊下の長尺シート端部シール不良"],
            "共用部階段": ["共用部階段のノンスリップ金物固定不良", "共用部階段の長尺シート浮き、剥がれ"],
            "手摺関係": ["手摺の固定不良（がたつき）、キズ"],
            "雨樋関係": ["雨樋（竪樋）の固定不良、傾き", "雨樋（這樋）の固定不良"],
            "電気設備関連": ["照明器具の点灯不良", "スイッチ、コンセントのプレート曲がり、隙間"],
            "消火・避難器具": ["消火器の設置不良", "避難器具（ハッチ等）の作動不良"],
            "掲示板関係": ["掲示板の取付不良、傾き"],
            "集合ポスト": ["集合ポストの扉開閉不良"],
            "オートロック": ["オートロック盤の作動不良"],
            "天井・壁関係": ["天井材（ジプトーン等）の割れ、汚れ", "壁材（塗装等）のムラ、汚れ"],
            "巾木関係": ["巾木の浮き、剥がれ"],
            "メーターボックス": ["メーターボックスの扉開閉不良", "メーターボックス内の配管保温材不良"]
        },
        "外部": {
            "杭関連": ["境界杭復旧（敷地〇〇）", "分筆杭復旧（敷地〇〇）", "道路後退杭復旧（敷地〇〇）"],
            "側溝": ["破損が大きい側溝蓋補修、もしくは交換", "側溝掃除"],
            "土間コン関連・砂利・砂・砕石": ["土間コンクリートひび割れ", "土間コンクリートレベル是正", "所定の伸縮目地なし", "溝の砕石量不適。（土間とフラットにする）", "溝の砕石入れ不十分", "土留めブロック隣地との隙間の清掃、砂入れ", "土留めブロック隣地との隙間の砂追加", "土間コンクリート舗装未施工", "ブロック際砕石は、単粒黒砕石20-30に是正", "浸透マス砕石施工不十分", "水たまりあり"],
            "メーター・マス": ["メーター設置位置不良", "メーター設置精度不良", "メーター蓋清掃", "メーター位置不適（図面と相違、駐車の邪魔）", "最終枡に泥、ゴミあり"],
            "駐車場・駐輪場": ["駐車場ライン剥がれ", "駐車場輪留め・ライン未施工", "サイクルストッパー未施工"],
