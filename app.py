...
ISSUE_TEMPLATES = {
    "配筋検査": [
        ...
        "スリーブ補強筋がない",
        "土除去 防湿フィルム破れ",
        "FG4コンクリート打ちが図面と不整合のため是正",
        "鉄筋のあきが取れていない 粗骨材の最大寸法の1.25倍以上かつ25㎜以上確認",
        "人通口の端末筋の定着がスラブに伸びているため、梁定着にする"
    ],
    "躯体検査": [
        "ホールダウン金物取付不良",
        "大引き金物の取付不良",
        ...
        "合板が柱・スタッドに掛かっていない",
        "合板目地が空いていない",
        "防腐防蟻処理の塗布忘れ、もしくは処理不足",
        "防腐防蟻処理の塗布忘れ、もしくは処理不足（玄関）",
        "防腐防蟻処理の塗布忘れ、もしくは処理不足（ＵＢ）",
        "頭つなぎの継手位置不良。スタッド上で継ぐ",
        "上枠の継手位置不良。スタッド上で継ぐ",
        "204の欠き込みが大きすぎるため補強が必要",
        "スタッドの切り詰めが不適（スタッドの補強が必要）",
        "マグサの施工不良",
        "壁合板の釘打ち不良。＠100",
        "壁合板の釘打ち不良。＠150",
        "合板の釘めり込み",
        ...
        "あおり止め金物未施工",
        "あおり止め金物釘打ち不良",
        "たる木ひねり金物（TS）の施工忘れ、もしくは施工不良",
        "各種金物の施工忘れ、もしくは施工不良",
        "各種金物の釘打ち不良"
    ],
    "中間検査": [
        "PB張り不足",
        "PB張り上げ不足。母屋たる木まで張り上げ。",
        "PBボード開口が大き過ぎる。石膏ボード張り増しすること",
        "ＰＢ留め付け不良※全室、全箇所確認のこと",
        "開口部周りＰＢ留め付け不良※全室、全箇所確認のこと",
        "竪穴区画範囲の壁PBは合板下端まで張り上げること　施工マニュアル（ＳＴ－０２－０１）確認のこと",
        "竪穴区画範囲の壁PBは隙間なく張り付けること",
        "壁PB施工がされていない（矩計図参照）",
        "外壁壁はPBをモヤ下まで張りあげる",
        "PS内の床に石膏ボード12.5張りがされていない",
        "界壁ＰＢの床根太、床合板取合い耐火材（スキマナイト等）未処理　※全室、全箇所確認のこと",
        "ビスピッチ不良　壁：外周部＠100中間部＠200になっていない＊全住戸確認すること",
        "150φダクト貫通部の開口補強下地に全周ビス固定＠100がされていない　※全室、全箇所確認のこと　",
        "ボードビスなし　※全室、全箇所確認のこと",
        "壁PBジョイントあて木なし（留め付けなし）",
        "界壁の遮音シートは、野地合板まで施工すること",
        "界壁は野地合板まで施工",
        "ニッチの設置高さ不良",
        "ニッチのサイズ不良",
        "縦管の音ナイン等に隙間処置をすること",
        "施工範囲内に音ナイン等が施工されていない",
        "防振吊り木受け材のころびとのクリアーなし",
        "防振吊り木受け材の床根太とのクリアーなし",
        "防振根太に固定金物使用。防振根太から根太に固定金物位置を移動",
        "防振根太に固定金物を使用している。防振根太から根太に固定金物位置を移動する",
        "壁内のダクト被覆が無い",
        "電気配線の縦貫通が1/2を超えている。PGで補強",
        "150Φダクト壁貫通位置不良。開口補強追加施工、もしくは開口補強位置是正",
        "電気配線界壁貫通",
        "竪穴区画内　日東化成株式会社（プラシール　NF-12HM）未済",
        "電気配線等の貫通部隙間の不燃材埋め（注意喚起）",
        "各種配管等の貫通部隙間の不燃材埋め",
        "150Φダクトの貫通部隙間不燃材（ロックウール等）埋め",
        "鋼製ダクト（スパイラル管）未施工",
        "基礎　立上り断熱材　隙間の処理が現場発泡ウレタンで塞いでいない",
        "基礎と土台の隙間処理（現場発泡ウレタン）が施工されていない　※外周部と玄関土間周り",
        "壁の断熱材が隙間なく充填されていない",
        "壁の断熱材が防湿フィルムで覆われていない（耳を柱に見付けタッカー留め）",
        "コンセントボックス、スイッチボックス周りの防湿処理が不十分",
        "床の断熱材が隙間なく充填されていない（大引きとの取合い・配管周り等の隙間など）",
        "床の断熱材が専用ピンで大引き等に密着するよう留め付けられていない",
        "天井の断熱材が隙間なく充填されていない（各種配線、配管等の貫通部の隙間など）",
        "天井の断熱材が防湿フィルムで覆われていない（耳を野縁に見付けタッカー留め）",
        "ダウンライト等の天井開口部周りの断熱処理不十分",
        "点検口等の開口部周りの断熱処理不十分",
        "バルコニー等の直下部における天井断熱材が隙間なく充填されていない",
        "外断熱材のジョイント部における気密テープ処理不十分",
        "外断熱材の開口部周りにおける気密テープ処理不十分",
        "サッシ周りの断熱処理不十分（現場発泡ウレタン等）",
        "玄関ドア周りの断熱処理不十分（現場発泡ウレタン等）",
        "浴室周りの断熱処理（基礎断熱、壁断熱、天井断熱）が不十分",
        "ユニットバス下部の基礎断熱処理不十分",
        "通気層が確保されていない（外壁、屋根など）",
        "通気層の入り口（土台水切り部など）が塞がれている",
        "通気層の出口（軒天、棟部など）が塞がれている",
        "防湿フィルムの破れ、剥がれがある場合は補修テープで処理すること",
        "防湿フィルムのジョイント部における重なり幅が不足している",
        "防湿フィルムのジョイント部におけるテープ処理不十分",
        "外壁透湿防水シートの破れ、剥がれがある場合は補修テープで処理すること",
        "外壁透湿防水シートのジョイント部における重なり幅が不足している",
        "外壁透湿防水シートのジョイント部におけるテープ処理不十分",
        "サッシ周りの防水テープ処理不十分",
        "配管等の貫通部周りの防水テープ処理不十分",
        "バルコニー防水層（FRP等）の施工不良（ひび割れ、浮き、ピンホールなど）",
        "バルコニー防水層の立ち上がり高さ不足",
        "バルコニー防水層とサッシ等の取合い部における防水処理不十分",
        "屋根葺き材の施工不良（割れ、浮き、ズレなど）",
        "屋根ルーフィングの破れ、剥がれがある場合は補修テープで処理すること",
        "屋根ルーフィングのジョイント部における重なり幅が不足している",
        "屋根ルーフィングの谷部、ケラバ部等における増張り処理不十分"
    ],
    "社内検査(設計)": {
        "玄関": [
            "玄関見切りトメ仕上り不良",
            ...
            "シューズボックス扉調整。扉傾き",
            "シューズボックス扉調整。壁に擦る",
            "シューズボックス扉調整。ボックスに対して斜めっている",
            "シューズボックス扉バタンとうるさい。涙目設置",
            "シューズボックスとクロス取り合い隙間をコーキング処理",
            "シューズボックスリペア",
            "シューズボックス取付位置是正",
            "シューズボックス丁番外れ",
            "シューズボックス建具受け用涙目設置",
            "シューズボックスの開き勝手が逆",
            "シューズクローク下端のコーキング未済",
            "シューズボックス閉時隙間広い。 プッシュ金具の調整",
            "玄関戸の戸当たりなし",
            "英文字の位置を玄関戸ライン側に是正",
            "玄関戸固定ビスとコーキング未施工",
            "玄関戸固定ビス頭コーキング未施工",
            "玄関戸下のはみだし材除去",
            "玄関戸固定シールはみ出し。サッシ固定ビスなし。",
            "玄関戸アングルピース下隙間及び横隙間のシーリング、及び固定ビス頭コーキング未施工",
            "玄関戸下のはみ出しシール材カット",
            "玄関戸キズあり。リペア",
            "玄関戸丁番のビスキャップが無い",
            "玄関戸の開閉かたい",
        ...
        "トイレ": [
            ...
            "鍵がかからない",
            "建具調整",
            "レバーハンドルが建具枠に当たらないよう戸当たり位置調整。",
            "戸当たりゴムパッキンカット",
            "建具枠下隙間コーキング処理（コーキング　白）",
            "タオル掛けがたつき",
            "タオル掛け傾き",
            "ペーパーホルダーがたつき",
            "ペーパーホルダー傾き",
            ...
            "巾木浮き、歪み是正",
            "巾木小口処理",
            "巾木下の隙間をコーキング処理（コーキング　白）",
            "巾木下の隙間をコーキング処理（ボンドコーク　白）",
            "巾木反り",
            "巾木留め付けビス頭処理（同色ボンドコーク）",
            "便器の固定不良（がたつき）",
            "便器からの漏水",
            "ウォシュレットの作動不良",
            "手洗い器の固定不良（がたつき）",
        ...
        "キッチン": [
            ...
            "ダクト未施工",
            "ダクト被覆不十分",
            "ダクトのPB貫通部未処理、ダクト被覆不十分",
            "配管のPB貫通部未処理",
            "配管のPB貫通部処理不十分",
            "配管カバー浮き。テープ未施工",
            "配管隙間カバー取付け",
            "配管隙間カバー取付け、及び排水管をまっすぐにする",
            "排水管をまっすぐにする",
            "配管カバー未設置",
            "キッチン壁がバチっているので是正",
            "キッチン壁際の隙間調整。",
            "キッチンパネル見切りがたつき",
            "キッチン際のコーキング仕上り不良（凹み過ぎ）",
            "キッチン際のコーキング仕上り不良",
            "キッチンパネルと床の取り合い隙間コーキング処理",
            "壁PB留め付けピッチ不良",
            "天井PB貼り不足",
            "PB貼り不足",
            "キッチンパネルのキズ、汚れ",
        ...
        "LDK": [
            ...
            "サッシ固定ビスなし コーキング処理なし",
            "サッシ固定シールはみ出し",
            "サッシ固定シールはみ出し。サッシ固定ビスなし。",
            "サッシ固定ビス傾き。是正後、ビス頭コーキング処理。",
            "サッシレール歪みあり",
            "サッシの開閉が重い",
            "サッシの鍵（クレセント）がかかりにくい",
            "網戸の動きが悪い、外れやすい",
        ...
        "バルコニー": [
            "軒天サイディング留め付け材不適。釘留めとする。",
            "軒天サイディング釘打ち間違い処理不良。きれいに処理できなければ張替え。",
            "軒天サインディング欠け",
            "軒天サイディング釘頭浮き",
            "軒天サイディング釘頭処理不良",
            "サイディング欠け・割れ",
            ...
            "物干し金物の固定不良、高さ・位置不良",
            "FRP防水層のひび割れ、浮き",
            "FRP防水層のトップコート色ムラ、剥がれ",
            "バルコニーサッシ下端の防水処理不良",
            "バルコニーの勾配不良（水たまり）",
            "外壁サイディングのジョイント部シーリング不良",
            "笠木のジョイント部シーリング不良",
            "笠木の固定不良、キズ"
        ],
        "洋室": [
            "引き戸建具調整",
            "左が奥に是正",
            "引き戸の建付け調整。閉めたときに隙間あり。",
            "引き戸建具開閉時に引っ掛かりあり",
            "引き戸建具枠小口処理",
            "引き戸 戸当たりクッションカット",
            "引き戸の引手浮き調整",
            "引き戸建具枠下とフローリングの隙間コーキング",
            "CL建具調整（ストッパーに位置を5㎝に是正）",
            "CL建具開閉時に引っ掛かりあり",
            "CL建具枠上の隙間コーキング",
            "CL建具枠小口処理",
            "CL建具枠のビスキャップが無い",
            "扉と扉の接触",
            "CL建具枠下とフローリングの隙間コーキング",
            "枕棚のクロス取合い隙間",
            "枕棚の固定不十分",
            "枕棚の前框がたつき",
            "枕棚上の雑巾ずり浮き",
        ...
        "外部": [
            ...
            "溝の砕石量不適。（土間とフラットにする）",
            "溝の砕石入れ不十分",
            "土留めブロック隣地との隙間の清掃、砂入れ",
            "土留めブロック隣地との隙間の砂追加",
            "土間コンクリート舗装未施工",
            "ブロック際砕石は、単粒黒砕石20-30に是正",
            "浸透マス砕石施工不十分",
            "水たまりあり",
            "メーター設置位置不良",
            "メーター設置精度不良",
