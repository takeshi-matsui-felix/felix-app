...
<style>
    ...
    /* スマホでカラムが縦に崩れるのを防ぎ、物件名と削除ボタンを横並びにする */
...
def main():
    ...
    if st.session_state.active_menu == "物件登録（管理者）":
        ...
        for p in props:
            ...
            c1, c2 = st.columns([7, 3]) # ボタン幅のバランスを最適化
    ...
    # 4. 是正確認 / 5. 完了分一覧 (ずらっと表示・一括処理モードへ変更)
